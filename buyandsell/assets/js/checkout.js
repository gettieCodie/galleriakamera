document.addEventListener('DOMContentLoaded', function() {
    // Get total amount dynamically from order summary
    const orderSummary = document.querySelector('.order-summary');
    const totalAmountVariable = orderSummary ? parseFloat(orderSummary.dataset.total) || 0 : 0;
    ...
    function saveOrderAndShipping() {
        ...
        // FIXED: Changed to absolute path
        return fetch("/galleriakamera/buyandsell/core/db_shippingadd.php", {
            method: "POST",
